...
def generate_launch_description():
    package_name = 'z_arm_2442c0_model'
    robot_name = 'z_arm_2442c0'

    pkg_share = FindPackageShare(package=package_name).find(package_name)
    urdf_model_path = os.path.join(pkg_share, f'urdf/z_arm_2442c0.urdf.xacro')
    ...
    # load_joint_trajectory_base_controller = ExecuteProcess(
    #     cmd=['ros2', 'control', 'load_controller', '--set-state', 'active',
